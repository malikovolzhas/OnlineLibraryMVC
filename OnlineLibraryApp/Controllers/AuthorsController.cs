...
namespace OnlineLibraryApp.Controllers
{
    public class AuthorsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,last_name,first_name")] Author author)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,last_name,first_name")] Author author)
        {
            if (ModelState.IsValid)
            {
